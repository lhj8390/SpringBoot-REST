...
public class ProductControllerTest {
    ...
    private static Stream<Arguments> invalidSaveParameter() {
        return Stream.of(
            Arguments.of(new ProductSaveRequestDTO("name", "thum", 0, 1, ProductCategory.ELECTRONIC)),
            Arguments.of(new ProductSaveRequestDTO("", "thum", 1, 1, ProductCategory.ELECTRONIC)),
    ...
    private static Stream<Arguments> invalidUpdateParameter() {
        return Stream.of(
                Arguments.of(new ProductUpdateRequestDTO("name", 0, 1, ProductCategory.ELECTRONIC)),
                Arguments.of(new ProductUpdateRequestDTO("name", 4, 1, null)),
                Arguments.of(new ProductUpdateRequestDTO("", 2, 1, ProductCategory.ELECTRONIC))
        );
    }
}
